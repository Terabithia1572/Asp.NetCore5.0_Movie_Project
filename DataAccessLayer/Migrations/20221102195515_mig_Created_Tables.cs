...
{
    public partial class mig_Created_Tables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentUnLike = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MovieExtraID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MovieQuality = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MovieAge = table.Column<int>(type: "int", nullable: false),
                    MovieExtraStatus = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieExtras", x => x.MovieExtraID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieCountry = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MovieTrailer = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MovieStars = table.Column<int>(type: "int", nullable: false),
